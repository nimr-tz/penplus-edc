        ...
        if (Input::get('add_results')) {
            ...
            if ($validate->passed()) {
                try {
                    ...
                    Redirect::to('add_results.php?successMessage=' . $successMessage);
                        ...
                        <div class="container">
                            ...
                            <form id="validation" method="post">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($override->get('lab_requests', 'status', $_GET['status']) as $value) {
                                ...
                                <div class="text-center">
                                    <input type="submit" name="add_results" class="btn btn-success" value="Update Results">
                                </div>
                            </form>
                        </div>
                    </div>

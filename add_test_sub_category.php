...
if ($user->isLoggedIn()) {
    if (Input::exists('post')) {
        ...
        if (Input::get('add_sub_category')) {
            ...
            if ($validate->passed()) {
                try {
                    $test_category = $override->get('sub_category', 'name', Input::get('name'));
                    if ($test_category) {
                        $errorMessage = 'New Test Sub Category Already Added';
                    } else {
                        $user->createRecord('sub_category', array(
                            'category' => Input::get('category'),
                            'name' => Input::get('name'),
                            'status' => Input::get('status'),
                            'description' => Input::get('description'),
                        ));
                        $successMessage = 'New Test Sub Category Added';
                    }
                } catch (Exception $e) {
                    die($e->getMessage());
                }
            ...
            if ($validate->passed()) {
                try {
                    ...
                    $successMessage = 'New Test Sub Category Updated';
                } catch (Exception $e) {
                    die($e->getMessage());
                }
            } else {
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $test_sub_category = $override->get('sub_category', 'delete_flag', 0);
            ?>
                        ...
                        <div class="container-fluid">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $i = 1;
                                    foreach ($test_sub_category as $value) {
                                                ...
                                                <form method="post">
                                                    <div class="modal-content">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="category" class="form-control form-control-border" placeholder="Enter test Name" required>
                                                                        ...
                                                                        <?php foreach ($override->get('category', 'status', 1) as $value_name) { ?>
                                                                            <option value="<?= $value_name['id'] ?>"><?= $value_name['name'] ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="submit" name="update_sub_category" value="Update Sub Category" class="btn btn-info">

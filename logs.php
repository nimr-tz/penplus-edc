        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>RECRUITMENTS LOG STATUS</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">RECRUITMENTS LOG STATUS</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <div class="card card-outline card-primary rounded-0 shadow">
                <div class="card-header">
                    <h3 class="card-title">PENPLUS RECRUITMENTS LOG AS OF <?= date('Y-m-d') ?></h3>
                    <div class="card-tools">
                        <a class="btn btn-default border btn-flat btn-sm" href="dashboard.php"><i class="fa fa-angle-left"></i> Back</a>
                        <a class="btn btn-flat btn-sm btn-primary" href="report2.php"><span class="fas fa-download text-default">&nbsp;&nbsp;</span>Download Report</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">

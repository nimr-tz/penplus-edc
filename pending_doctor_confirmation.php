        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>List of Pendind Doctor Confirmation</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">List of Pendind Doctor Confirmation</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="container-fluid">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    $not_confirmed = $override->getNews('screening', 'ncd', 2, 'doctor_confirm', 0);

                                    foreach ($not_confirmed as $value) {
                                            ...
                                            <td class="text-center">
                                                ...
                                                switch ($value['doctor_confirm']) {
                                                    case 0:
                                                        ...
                                                        break;
                                                    case 1:
                                                        echo '<span class="rounded-pill badge badge-primary ">Confirmed</span>';
                                                        break;
                                                    case 2:
                                                        echo '<span class="rounded-pill badge badge-warning ">Not Needed</span>';
                                                        break;
                                                }
                                                ?>
                                            </td>

                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="3"> Thromboembolic </th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    foreach ($site_data as $row) {
                                        ...
                                        $cardiac1 = $override->countData2('cardiac', 'status', 1, 'sub_thromboembolic', 1, 'site_id', $row['id']);
                                        $cardiac_Total1 = $override->countData('cardiac', 'status', 1, 'sub_thromboembolic', 1);
                                        $cardiac2 = $override->countData2('cardiac', 'status', 1, 'sub_thromboembolic', 2, 'site_id', $row['id']);
                                        $cardiac_Total2 = $override->countData('cardiac', 'status', 1, 'sub_thromboembolic', 2);
                                        $cardiac7 = $override->countData2('cardiac', 'status', 1, 'sub_thromboembolic', 96, 'site_id', $row['id']);
                                        $cardiac_Total7 = $override->countData('cardiac', 'status', 1, 'sub_thromboembolic', 96);
                                    ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['name'] ?></td>

                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="6"> Right Heart Failure </th>
                                    </tr>
                                    <tr>
                                        <th>Chronic Lung Diseases</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($site_data as $row) {
                                        ...
                                        $cardiac1 = $override->countData2('cardiac', 'status', 1, 'sub_heart_failure', 1, 'site_id', $row['id']);
                                        $cardiac_Total1 = $override->countData('cardiac', 'status', 1, 'sub_heart_failure', 1);
                                    ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['name'] ?></td>
